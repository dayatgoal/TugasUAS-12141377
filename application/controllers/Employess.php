...
class Employess extends CI_Controller 
{
	...
	public function index(){
		...
		$this->load->view('employees/employees_view', $data); //menampilkan view 'products_view' dan juga passing data dengan nama $data(Bentuknya array) yang berisi 'listProducts'
